...
export default class PermissionAnalyzerObject extends LightningElement {
    ...
    //This Method is used to search input event handler  for Object
    handleSearchKeyChange(event) {
        this.searchKey = event.target.value;
        this.hasObjects = this.filteredObjList.length > 0 ? true : false;
    }
    ...
    handleDependencies(changedPermission, isChecked) {
        ...
        //let objDependentPerm = structuredClone(this.objDepPermissions);
    ...
    fieldPermissonCacheHandler(event){
        ...
        console.log('OUTPUT : ',JSON.stringify(this.fieldPermissionsCache));
    }
