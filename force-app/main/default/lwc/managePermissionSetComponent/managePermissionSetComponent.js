...
export default class ManagePermissionSetComponent extends LightningElement {
    ...
    getPerSetRowActions(row, doneCallback) {
        const actions = [
            // {
            //     label: 'Assign Permission Set to Users',
            //     name: 'assignperset'
            // },
            // {
            //     label: 'Unassign Permission Set From Users',
            //     name: 'unassignperset'
            // },
            {
    ...
    handleCloneforPermissionSetwithusers() {
        ...
        //this.userDescriptionCloneforPermissionSet = this.userDescription;
    }
