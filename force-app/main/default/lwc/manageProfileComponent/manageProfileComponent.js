...
export default class ManageProfileComponent extends LightningElement {
    ...
    handleProfileChange() {
        ...
        this.objList = [];
        getProfileusers({
                profId: this._profileValue.profileId
            })
            .then((result) => {
                console.log('result', result);
                this.userValue = result.userList.map(res => {
                    return {
                        Name: res.Name,
    ...
    getSobjectPermissionsForProfile(permSetId, objName) {
        getSobjectPermissionsForProfile({
            ...
            .then(res => {
                ...
                // this.fieldPermissions.sort((a, b) => {
                //     if (a.PermissionsRead && a.PermissionsEdit && !(b.PermissionsRead && b.PermissionsEdit)) return -1;
                //     if (b.PermissionsRead && b.PermissionsEdit && !(a.PermissionsRead && a.PermissionsEdit)) return 1;
                //     if ((a.PermissionsRead || a.PermissionsEdit) && !(b.PermissionsRead || b.PermissionsEdit)) return -1;
                //     if ((b.PermissionsRead || b.PermissionsEdit) && !(a.PermissionsRead || a.PermissionsEdit)) return 1;
                //     if (!(a.PermissionsRead || a.PermissionsEdit) && (b.PermissionsRead || b.PermissionsEdit)) return 1;
                //     if (!(b.PermissionsRead || b.PermissionsEdit) && (a.PermissionsRead || a.PermissionsEdit)) return -1;
        ...
        updateObjPermissions({
            ...
            .then(res => {
                ...
                if (res != null) {
                    ...
                    // if (res.fieldPerms.length > 0) {
                    //     this.fieldPermissions = this.fieldPermissions.map(field => {
                    //         let updatedField = res.fieldPerms.find(updated => updated.Field === field.Field);
