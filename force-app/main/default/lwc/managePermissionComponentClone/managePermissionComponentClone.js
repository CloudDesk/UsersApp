...
//This Method is used to handle the Field Permissions change
   ...
   handlePermissionHandlerCall(userPermissions, objNameValue, objPermissionValue, fieldObj, fieldNameVal, fieldPermVal, permValue) {
        this.sortColumn = '';
        this.sortDirection = '';
        this.textFilters = {};
        this.comboFilters = {};
        ...
        getPermsandUsersOfSelectedPerms({
   ...
   handlePermissionSetChange(event) {
    ...
    handleSearch(event) {
        ...
        this.textFilters[column] = searchTerm.toLowerCase();
        this.applyFiltersAndPagination();
    }
