//This Component is used to handle permissions based on user's profile, permissonset and permissionsetGroup
//This Component is parent for UserPermissionAnalyzer, TabPermissionAnalyzer, PermissionAnalyzerObject, managePermissionComponent
...
export default class PermissionAnalyzer extends LightningElement {
    ...
    handleUserClick(event) {
        this.userNameClick = true;
        this.userId = event.target.dataset.parentid;
        this.searchusername = event.target.dataset.name;
        this.userProfileId = event.target.dataset.id;
        this.showSpinner = true;
        this.isUserObject = false;
        this.isPermissionEnabledUser = false;
        this.handleGetUserPermsWrapper(this.userId);
